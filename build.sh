...
TS_VAR=$(date +%s)
docker build --platform=linux/amd64 -t registry.service.home.consul/consul-esm:$TS_VAR-amd64 .
docker push registry.service.home.consul/consul-esm:$TS_VAR-amd64
docker build --platform=linux/arm64/v8 -t registry.service.home.consul/consul-esm:$TS_VAR-arm64 .
